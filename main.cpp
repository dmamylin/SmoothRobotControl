...
// На входе: 2 цели в пользовательской системе координат
// На выходе: четырехмерный вектор вида:
//            x - растояние между ними
//            y - путевой угол робота в точке target1
//            z - путевой угол цели в точке target2
//            w - желательная линейная скорость в точке target2
